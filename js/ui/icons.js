/**
 * Icon Library - Updated with official Lucide paths
 */
const ATTRS =
...
const PATHS = {
  ...
  "thermometer-sun":
    '<path d="M12 2v2"></path><path d="M12 8a4 4 0 0 0-1.645 7.647"></path><path d="M2 12h2"></path><path d="M20 14.54a4 4 0 1 1-4 0V4a2 2 0 0 1 4 0z"></path><path d="m4.93 4.93 1.41 1.41"></path><path d="m6.34 17.66-1.41 1.41"></path>',
...
export function getIcon(name, size = 24, className = "") {
  const path = PATHS[name] || PATHS.settings;
  return `<svg ${ATTRS} width="${size}" height="${size}" class="lucide ${className}">${path}</svg>`;
}
